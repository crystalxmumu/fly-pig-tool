...
INSERT INTO bm_static_data_def(sdd_id, sdd_ddd_id, sdd_code, sdd_name, sdd_value, sdd_rel_ddd, sdd_rel_sdd, sdd_ext_1, sdd_ext_2, sdd_ext_3, sdd_is_delete, sdd_desc, sdd_sort, sdd_remark) VALUES ('${(data.uid)!}','${(data.parent.uid)!}','${(data.code)!}','${(data.name)!}','${(data.value)!}', NULL, NULL, '${(data.ext1)!}', '${(data.ext2)!}', '${(data.ext3)!}', ${(data.del)!}, '${(data.desc)!}',${(data.order)!?c},'${(data.remark)!}');
